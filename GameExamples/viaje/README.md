...
This folder contains the game Trabajo Basura (Dire Job), Android TCP/IP Virtual Joystick compatible version. This version does not include the main music theme.
