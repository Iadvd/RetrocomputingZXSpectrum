...
#define PLAYER_MIN_KILLABLE 	1		// Only kill enemies with id >= PLAYER_MIN_KILLABLE
...
unsigned char comportamiento_tiles [] = {
	0, 0, 4, 0, 1, 0, 4, 8, 4, 4, 4, 4, 0, 4, 4, 10,
