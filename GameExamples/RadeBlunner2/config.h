...
#define PLAYER_MIN_KILLABLE_SP 	0		// Only kill enemies with id >= PLAYER_MIN_KILLABLE
...
unsigned char comportamiento_tiles [] = {
	0, 8, 8, 0, 0, 8, 0, 4, 4, 0, 4, 4, 4, 4, 1, 10,
