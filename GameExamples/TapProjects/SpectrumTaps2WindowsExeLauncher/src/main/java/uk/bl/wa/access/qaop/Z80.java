...
// case 0x00: break;
                ...
                break;
                case 0x18:
                    MP = PC = (char) (PC + 1 + (byte) env.mem(PC));
                    time += 8;
                    break;
                case 0x09:
                    HL = add16(HL, B << 8 | C);
...
// case 0x7F: break;
                ...
                case 0xCD:
                    ...
                    break;
                case 0xD3:
                    env.out(v = imm8() | A << 8, A);
                    MP = v + 1 & 0xFF | v & 0xFF00;
                    time += 4;
                    break;
                case 0xDB:
                    MP = (v = imm8() | A << 8) + 1;
...
// -------------- >8
            default:
                System.out.println(PC + ": Not emulated ED/" + c);
        }
    }
