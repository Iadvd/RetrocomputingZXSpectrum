...
1. Install Fuse ZX Spectrum emulator (use the emulation of the 48K version)  + Spectranet emulator. Of Spectranet is correctly installed you will get a local IP for the Spectrum.
