...
#endif
#include "enems.h"
void peta_el_beeper (unsigned char);	// Prototipo
#include "engine.h"
#include "beeper.h"
...
void main (void) {
	...
	#asm
		...
		; Data
		line: 
			defb 'Z','o','m','b','i','e',' ','C','a','l','a','v','e','r','a',' ','P','r','o','l','o','g','u','e','.',' ','A','n','d','r','o','i','d',' ','V','i','r','t','u','a','l',' ','J','o','y','s','t','i','c','k',' ','c','o','m','p','a','t','i','b','l','e',' ','v','e','r','s','i','o','n','.','W','a','i','t',' ','o','r',' ','a','n','y',' ','k','e','y',' ','t','o',' ','c','a','n','c','e','l','.','.','.',13,'$'
