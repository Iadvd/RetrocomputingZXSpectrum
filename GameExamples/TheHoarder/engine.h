...
void game_ending (void) {
	...
	// EN
	print_str (6, 16, 32, "                     ");
	print_str (6, 17, 32, " IN THIS GAME NOBODY ");
	print_str (6, 18, 32, " WINS:STOP HOARDING! ");
	print_str (6, 19, 32, "                     ");
	
	// SP
	//print_str (5, 16, 32, "                      ");
	//print_str (5, 17, 32, " EN ESTE JUEGO. NADIE ");
	//print_str (5, 18, 32, " GANA: NO ACAPARES,,, ");
	//print_str (5, 19, 32, "                      ");
...
void game_over (void) {
	...
	// EN
	print_str (6, 10, 32, "                    ");
	print_str (6, 11, 32, " GAME OVER!         ");
	print_str (6, 12, 32, " LET'S HOARD AGAIN! ");
	print_str (6, 13, 32, "                    ");
	
	// SP
	//print_str (5, 10, 32, "                      ");
	//print_str (5, 11, 32, " GAME OVER. NO TIENES ");
	//print_str (5, 12, 32, " SUFICIENTE PAPEL,,,  ");
	//print_str (5, 13, 32, "                      ");
