...
// Compilada con splib2t.lib, versión especial modificada por mí.
// Esta versión de splib2 pinta o no los atributos dependiendo de
...
void main (void) {
	...
	#asm
		...
		; Data
		line: 
			defb 'T','e','n','e','b','r','a',' ','M','a','c','a','b','r','e','.',' ','A','n','d','r','o','i','d',' ','V','i','r','t','u','a','l',' ','J','o','y','s','t','i','c','k',' ','c','o','m','p','a','t','i','b','l','e',' ','v','e','r','s','i','o','n','.','W','a','i','t',' ','o','r',' ','a','n','y',' ','k','e','y',' ','t','o',' ','c','a','n','c','e','l','.','.','.',13,'$'
