...
void main (void) {
	...
	#asm
		...
		; Data
		line: 
			defb 'L','a','l','a',' ','P','r','o','l','o','g','u','e','.',' ','A','n','d','r','o','i','d',' ','V','i','r','t','u','a','l',' ','J','o','y','s','t','i','c','k',' ','c','o','m','p','a','t','i','b','l','e',' ','v','e','r','s','i','o','n','.','W','a','i','t','i','n','g',' ','f','o','r',' ','a','n',' ','A','n','d','r','o','i','d',' ','J','o','y','s','t','i','c','k','.',13,'$'
	...
	while (1) {
		...
		#asm
			; ¡qué guarro! 
			; Pues sí, en 59000 hay una rutina de Wham! que
			; toca una música de mierda.
			
			call 59000
			di				; ¡PFFFF! Viva el Epetrun 48Kas
		#endasm
		cortina ();
