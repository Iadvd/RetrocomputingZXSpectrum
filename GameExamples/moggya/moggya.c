...
void main (void) {
	...
	#asm
		...
		; Data
		line: 
			defb 'M','o','g','g','y',' ','A','d','v','e','n','t','u','r','e','.',' ','A','n','d','r','o','i','d',' ','V','i','r','t','u','a','l',' ','J','o','y','s','t','i','c','k',' ','c','o','m','p','a','t','i','b','l','e',' ','v','e','r','s','i','o','n','.','W','a','i','t',' ','o','r',' ','a','n','y',' ','k','e','y',' ','t','o',' ','c','a','n','c','e','l','.','.','.',13,'$'
